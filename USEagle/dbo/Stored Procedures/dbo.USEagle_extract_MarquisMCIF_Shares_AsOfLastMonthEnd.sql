...
IF EXISTS (SELECT * FROM sys.objects WHERE schema_id = SCHEMA_ID('dbo') AND name = 'USEagle_extract_MarquisMCIF_Shares_AsOfLastMonthEnd')
	DROP PROCEDURE dbo.USEagle_extract_MarquisMCIF_Shares_AsOfLastMonthEnd;
GO


CREATE PROCEDURE dbo.USEagle_extract_MarquisMCIF_Shares_AsOfLastMonthEnd

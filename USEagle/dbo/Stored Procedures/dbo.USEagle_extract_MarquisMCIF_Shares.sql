...
IF EXISTS (SELECT * FROM sys.objects WHERE schema_id = SCHEMA_ID('dbo') AND name = 'USEagle_extract_MarquisMCIF_Shares')
	DROP PROCEDURE dbo.USEagle_extract_MarquisMCIF_Shares;
GO


CREATE PROCEDURE dbo.USEagle_extract_MarquisMCIF_Shares
...
BEGIN
	...
	WHERE
		Typ.ProductCategory2 = 'Regular Shares'
	ORDER BY
		Val;

...
IF EXISTS (SELECT * FROM sys.objects WHERE schema_id = SCHEMA_ID('dbo') AND name = 'USEagle_extract_MarquisMCIF_Certificates')
	DROP PROCEDURE dbo.USEagle_extract_MarquisMCIF_Certificates;
GO


CREATE PROCEDURE dbo.USEagle_extract_MarquisMCIF_Certificates

...
IF EXISTS (SELECT * FROM sys.objects WHERE schema_id = SCHEMA_ID('dbo') AND name = 'USEagle_extract_MarquisMCIF_Checking_AsOfLastMonthEnd')
	DROP PROCEDURE dbo.USEagle_extract_MarquisMCIF_Checking_AsOfLastMonthEnd;
GO


CREATE PROCEDURE dbo.USEagle_extract_MarquisMCIF_Checking_AsOfLastMonthEnd
